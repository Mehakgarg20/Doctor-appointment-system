...
router.post('/mark-all-notifications-as-seen',authMiddleware, async(req,res)=>{
    try{
        ...
        console.log(error);
        return res.status(500).send({message:"Error marking all notifications as seen",success:false,error});
    }
});
...
router.post('/delete-all-notifications',authMiddleware, async(req,res)=>{
    try{
        ...
        console.log(error);
        return res.status(500).send({message:"Error deleting all notifications",success:false,error});
    }
});
